	...
	<a-layout-header v-if="!headerBarFixed" :class="[fixedHeader && 'ant-header-fixedHeader', sidebarOpened ? 'ant-header-side-opened' : 'ant-header-side-closed', ]"
	 :style="{ padding: '0' }">
		...
		<div v-if="mode === 'sidemenu'" class="header" :class="theme">
			...
			<span v-if="device === 'desktop'">欢迎进入赛达云CRM</span>
...
<style>
	.layout .header .user-wrapper .action .avatar{border-radius: 20px;}
	.layout .header.dark .user-wrapper .action{color: #fff;}
	.layout .header.dark span{color: #fff;}
	.layout .header.dark .anticon svg{color: #fff;}
</style>