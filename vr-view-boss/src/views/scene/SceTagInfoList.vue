<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('标签信息')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <sceTagInfo-modal ref="modalForm" @ok="modalFormOk"></sceTagInfo-modal>
  </a-card>
</template>

<script>
  import SceTagInfoModal from './modules/SceTagInfoModal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/scene/sceTagInfo/list",
          delete: "/scene/sceTagInfo/delete",
          deleteBatch: "/scene/sceTagInfo/deleteBatch",
          exportXlsUrl: "scene/sceTagInfo/exportXls",
          importExcelUrl: "scene/sceTagInfo/importExcel",
       },
    }
  },
  computed: {
