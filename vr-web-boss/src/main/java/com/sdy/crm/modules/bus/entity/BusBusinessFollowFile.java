 ...
 */
@Data
@TableName("bus_business_follow_file")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="bus_business_follow_file对象", description="商机跟进附件")
public class BusBusinessFollowFile {
	...
	/**商机跟进id*/
	@Excel(name = "商机跟进id", width = 15)
    @ApiModelProperty(value = "商机跟进id")
