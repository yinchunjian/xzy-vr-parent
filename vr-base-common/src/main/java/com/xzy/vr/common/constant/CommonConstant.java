package com.xzy.vr.common.constant;
...
public interface CommonConstant {
    ...
    /** 登录用户Shiro权限缓存KEY前缀 */
    public static String PREFIX_USER_SHIRO_CACHE  = "shiro:cache:com.xzy.boss.modules.shiro.authc.ShiroRealm.authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
    ...
    /** APP登录用户Shiro权限缓存KEY前缀 */
    public static String APP_PREFIX_USER_SHIRO_CACHE  = "shiro:cache:com.xzy.app.modules.shiro.authc.ShiroRealm.authorizationCache:";
    /** APP登录用户Token令牌缓存KEY前缀 */
    public static final String APP_PREFIX_USER_TOKEN  = "app_prefix_user_token_";
    /** APPToken缓存时间：3600秒即一小时 */
    public static final int  APP_TOKEN_EXPIRE_TIME  = 3600;
