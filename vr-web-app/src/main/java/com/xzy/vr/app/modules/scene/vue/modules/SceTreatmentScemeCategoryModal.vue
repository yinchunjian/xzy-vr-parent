...
<script>
  ...
  export default {
    name: "SceTreatmentScemeCategoryModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        url: {
          add: "/scene/sceTreatmentScemeCategory/add",
          edit: "/scene/sceTreatmentScemeCategory/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'categoryId','remark','delFlag','categoryName','systemId','systemName'))
		  //时间格式化
        });
